...
`;
  ...
  const registerFacebook = async () => {
    ...
    window.location.href = "https://www.elmarsa.mr/api/api/facebook";
  };
  const handleLogin = (e) => {
    e.preventDefault();
                  ...
                  <div className="mt-1 relative">
                    ...
                    <div className="space-y-4">
                      <PhoneInput
                        ...
                        id="phone"
                        name="phone"
                        inputClass={`!w-full !h-[38px] appearance-none block px-3 py-2 border ${errors.phone ? "border-red-300" : "border-gray-300"} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center space-x-3 my-3">
                    <input
                      ...
                      value={formData.phone}
                      disabled
                      className="bg-gray-200 text-gray-700 px-3 py-2 border border-gray-300 rounded-md shadow-sm w-full cursor-not-allowed"
                    />
                    <button
                      type="button"
                      onClick={() => sendCode(formData.phone)}
                      className="min-w-max py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700"
                    >
                      {t('send_code')}
                    </button>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={!messageSent || !codeSent ? "bg-gray-300 cursor-not-allowed  appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none  sm:text-sm text-center tracking-widest " : `appearance-none block w-full px-3 py-2 border ${errors.verification ? "border-red-300" : "border-gray-300"} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-center tracking-widest`}
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className={!messageSent || isLoading || !codeSent ? "cursor-not-allowed flex-1 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50" : "flex-1 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"}
                  >
            ...
            {step === 1 && (
              ...
              <div className="w-full max-w-md mx-auto space-y-4">
                ...
                <button
                  onClick={registerGoogle}
                  disabled={isDisabled}
                  className={`${buttonBaseClass} bg-red-500 hover:bg-red-600 focus:ring-red-500`}
                >
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      ...
                      type="text"
                      required
                      className={`cursor-not-allowed appearance-none block w-full px-3 py-2 border ${errors.phone ? "border-red-300" : "border-gray-300"} rounded-md shadow-sm placeholder-gray-400 focus:outline-none bg-gray-200 sm:text-sm`}
                      value={formData.phone}
                      onChange={handleInputChange}
                    />
                    {errors.phone && (
